    ...
    <div className="min-h-screen bg-slate-50 dark:bg-brand-navy flex font-body-md text-on-surface">
      ...
      <aside className="w-64 bg-white dark:bg-brand-navy border-r border-slate-200 dark:border-white/10 flex flex-col fixed h-full z-20">
        ...
        <div className="p-4 border-t border-slate-200 dark:border-white/10 space-y-2">
          <Link
            to="/"
            className="flex items-center gap-3 px-4 py-3 rounded-xl w-full text-brand-slate hover:bg-slate-100 dark:hover:bg-brand-navy/50 hover:text-brand-navy dark:hover:text-white font-bold transition-colors"
          >
