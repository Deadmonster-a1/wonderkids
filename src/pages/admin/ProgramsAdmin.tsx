  ...
  return (
    <div className="bg-white dark:bg-brand-navy rounded-2xl shadow-sm border border-slate-100 dark:border-white/10 overflow-hidden">
      <div className="p-6 border-b border-slate-100 dark:border-white/10 flex justify-between items-center">
        <h2 className="text-xl font-bold text-brand-navy dark:text-white">Manage Programs</h2>
        ...
        <table className="w-full text-left">
          <thead className="bg-slate-50 dark:bg-brand-navy/50 text-brand-slate">
            <tr>
              ...
              <th className="px-6 py-4 font-bold">Grade Range</th>
              <th className="px-6 py-4 font-bold">Icon Name (lucide)</th>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-brand-navy/50 backdrop-blur-sm overflow-y-auto">
          <div className="bg-white dark:bg-brand-navy rounded-2xl w-full max-w-lg shadow-xl border border-slate-100 dark:border-white/10 my-8">
            ...
            <form onSubmit={handleSave} className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-sm font-bold text-brand-navy dark:text-white mb-2">Grade Range</label>
              ...
              <div>
                <label className="block text-sm font-bold text-brand-navy dark:text-white mb-2">Icon Name (lucide)</label>
              ...
              <div>
                <label className="block text-sm font-bold text-brand-navy dark:text-white mb-2">Description</label>
              ...
              <div>
                <label className="block text-sm font-bold text-brand-navy dark:text-white mb-2">Theme Config (JSON)</label>
                
                <input 
                  type="text" 
                  value={formData.themeConfig || ''} 
                  onChange={e => setFormData({...formData, themeConfig: e.target.value})}
                  className="w-full px-4 py-2 rounded-lg bg-slate-50 dark:bg-brand-navy border border-slate-200 dark:border-white/10 focus:ring-2 focus:ring-brand-indigo outline-none dark:text-white"
                  required
                />
