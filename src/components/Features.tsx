...
export default function Features() {
  ...
  return (
    <section className="bg-white dark:bg-brand-navy py-16 md:py-24 relative overflow-hidden" ref={ref}>
      ...
      <div className="absolute -top-40 -right-40 w-96 h-96 bg-brand-sky/10 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-brand-indigo/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              <div className="w-12 h-12 rounded-[1rem] bg-amber-100 flex items-center justify-center text-2xl shadow-inner border-2 border-white">
                🏆
              </div>
              <div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 md:gap-6">
              {features.map((f, i) => (
                <motion.div
                  ...
                  className="h-full"
                >
                  <TiltCard maxRotation={5} scale={1.02} className="h-full">
