...
export default function Footer() {
  ...
  return (
    <footer className="relative z-10 bg-brand-navy pt-20 pb-10 text-brand-slate border-t border-transparent dark:border-white/10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4">
              {settings?.facebookUrl && (
                <a href={settings.facebookUrl} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-10 h-10 rounded-full bg-white dark:bg-white/5 flex items-center justify-center text-brand-navy dark:text-white hover:bg-brand-indigo dark:hover:bg-brand-indigo hover:text-white transition-colors">
                  <Facebook className="w-5 h-5" />
                </a>
              )}
              {settings?.instagramUrl && (
                <a href={settings.instagramUrl} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 rounded-full bg-white dark:bg-white/5 flex items-center justify-center text-brand-navy dark:text-white hover:bg-brand-indigo dark:hover:bg-brand-indigo hover:text-white transition-colors">
                  <Instagram className="w-5 h-5" />
                </a>
              )}
              {settings?.twitterUrl && (
                <a href={settings.twitterUrl} target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="w-10 h-10 rounded-full bg-white dark:bg-white/5 flex items-center justify-center text-brand-navy dark:text-white hover:bg-brand-indigo dark:hover:bg-brand-indigo hover:text-white transition-colors">
                  <Twitter className="w-5 h-5" />
                </a>
              )}
              {settings?.youtubeUrl && (
                <a href={settings.youtubeUrl} target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="w-10 h-10 rounded-full bg-white dark:bg-white/5 flex items-center justify-center text-brand-navy dark:text-white hover:bg-brand-indigo dark:hover:bg-brand-indigo hover:text-white transition-colors">
